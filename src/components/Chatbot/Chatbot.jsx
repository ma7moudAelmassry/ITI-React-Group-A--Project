...
function Chatbot() {
  ...
  async function retrieveMovies(message) {

    // Ask Groq what the user is asking for
    const analysis =
      await analyzeQuestion(message);
    ...
    // User is asking about a specific movie
  ...
  async function sendMessage(e) {
    ...
    try {
      ...
      const errorMessage = {
        role: "assistant",
        content:
          "Sorry, something went wrong while getting movie information.",
      };
